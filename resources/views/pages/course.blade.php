            ...
            <div class="ps-1">
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-1">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">{{ $course->short_name ?? '' }}</li>
                </ol>
              </nav>
              <h1 class="text-white fw-semibold mb-2">{{ $course->full_name }}</h1>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="col-single-section__bottom bg--light">
      ...
      <ul class="nav nav-tabs bg--body" id="colSingleTab" role="tablist">
        <li class="nav-item" role="presentation">
          <button class="nav-link active" id="info-tab" data-bs-toggle="tab" data-bs-target="#overview" type="button" role="tab" aria-controls="info" aria-selected="true">Overview</button>
        </li>
        <li class="nav-item" role="presentation">
          <button class="nav-link" id="courses-tab" data-bs-toggle="tab" data-bs-target="#jobs" type="button" role="tab" aria-controls="courses" aria-selected="false">Jobs</button>
        </li>
        <li class="nav-item" role="presentation">
          <button class="nav-link" id="admission-tab" data-bs-toggle="tab" data-bs-target="#syllabus" type="button" role="tab" aria-controls="admission" aria-selected="false">Syllabus</button>
        </li>
        <li class="nav-item" role="presentation">
          <button class="nav-link" id="reviews-tab" data-bs-toggle="tab" data-bs-target="#skills" type="button" role="tab" aria-controls="reviews" aria-selected="false">Skill Require</button>
        </li>
        <li class="nav-item" role="presentation">
          <button class="nav-link" id="placement-tab" data-bs-toggle="tab" data-bs-target="#admission" type="button" role="tab" aria-controls="placement" aria-selected="false">Admission</button>
        </li>
        <li class="nav-item" role="presentation">
          <button class="nav-link" id="faq-tab" data-bs-toggle="tab" data-bs-target="#faqs" type="button" role="tab" aria-controls="ranking" aria-selected="false">FAQ</button>
        </li>
      </ul>
            ...
            <div class="tab-content mb-3">
                ...
                <div class="info-block bg--body shadow--base rounded-2">
                    <div class="info-block__header p-3">
                        <h5 class="text--dark fw-semibold mb-0">{{ $course->short_name ?? '' }} Overview</h5>
                    </div>
                ...
                <div class="tab-pane" id="jobs" role="tabpanel" aria-labelledby="courses-tab">
                <div class="info-block bg--body shadow--base rounded-2">
                    <div class="info-block__header p-3">
                        <h5 class="text--dark fw-semibold mb-0">{{ $course->short_name ?? '' }} Jobs</h5>
                    </div>
                    <div class="info-block__body p-3">
                        <div class="content-box content-box--prose">
                          {!! $course_details->jobs !!}
                ...
                <div class="tab-pane" id="syllabus" role="tabpanel" aria-labelledby="admission-tab">
                    <div class="info-block bg--body shadow--base rounded-2">
                        <div class="info-block bg--body shadow--base rounded-2 mb-3">
                          <div class="info-block__header p-3">
                            <h5 class="text--dark fw-semibold mb-0">{{ $course->short_name ?? '' }} Syllabus</h5>
                          </div>
                          <div class="info-block__body p-3">
                                {!! $course_details->syllabus !!}
                          </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="tab-pane" id="skills" role="tabpanel" aria-labelledby="skills-tab">
                    <div class="info-block bg--body shadow--base rounded-2 mb-3">
                      <div class="info-block__header p-3">
                        <h5 class="text--dark fw-semibold mb-0">{{ $course->short_name ?? '' }} Skills</h5>
                      </div>
                      <div class="info-block__body p-3">
                        <div class="row">
                            {!! $course_details->skills !!}
                        </div>
                      </div>
                    </div>
                </div>
                ...
                <div class="tab-pane" id="admission" role="tabpanel" aria-labelledby="admission-tab">
                    <div class="info-block bg--body shadow--base rounded-2 mb-3">
                      <div class="info-block__header p-3">
                        <h5 class="text--dark fw-semibold mb-0">{{ $course->short_name ?? '' }} Admission</h5>
                      </div>
                      <div class="info-block__body p-3">
                            {!! $course_details->admission !!}
                      </div>
                    </div>
                </div>

                <div class="tab-pane" id="faqs" role="tabpanel" aria-labelledby="faq-tab">
                    <div class="info-block bg--body shadow--base rounded-2">
                        <div class="info-block__header p-3">
                            <h5 class="text--dark fw-semibold mb-0">{{ $course->short_name ?? '' }} FAQ</h5>
                        </div>
                        <div class="info-block__body p-3">
                            <div class="accordion-container">
                                @if($course_details->faqs != null)
                                @foreach(json_decode($course_details->faqs) as $faq)
                                <div class="set">
                                  <a href="#" class="">
